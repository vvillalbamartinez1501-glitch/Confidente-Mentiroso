    ...
    >
      <div className={`w-full h-full rounded-2xl overflow-hidden glass-panel shadow-[0_0_25px_rgba(0,0,0,0.3)] transition-all duration-500 ${isHidden ? 'bg-gray-800' : ''}`}>
        {!isHidden ? (
          ...
          <div className="w-full h-full flex flex-col items-center justify-center bg-[#1a1d2d] border-4 border-white/5">
            <div className="text-6xl mb-4 drop-shadow-2xl">❓</div>
            <p className="text-gray-400 font-bold tracking-widest text-sm uppercase">Secreto Oculto</p>
          </div>
        )}
      </div>
    </motion.div>
