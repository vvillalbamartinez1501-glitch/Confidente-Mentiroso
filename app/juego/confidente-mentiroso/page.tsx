...
import { 
  ...
  Type, LayoutGrid, Trophy, Heart, Skull, Zap, Target, Swords, UserCheck, Users, Plus, Home as HomeIcon
} from 'lucide-react';
          ...
          >
            ...
            <div className="mt-2 w-full">
               ...
               <div className="max-h-[30vh] overflow-y-auto no-scrollbar">
                 <Scoreboard players={sessionManager.activeSession?.players || []} scoringMode={game.scoringMode} compact />
               </div>
            </div>
        ...
        {game.gameState === 'game_over' && (
          ...
          >
             ...
             <div className="w-full max-h-[40vh] overflow-y-auto no-scrollbar">
               <Scoreboard players={sessionManager.activeSession?.players || []} scoringMode={game.scoringMode} />
             </div>
